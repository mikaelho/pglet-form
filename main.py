...
class Task():
    def __init__(self, app, name):
        ...
        self.edit_view = Stack(visible=False, horizontal=True, horizontal_align='space-between',
                vertical_align='center', on_submit=self.save_clicked, controls=[
    ...
    def changed(self, e):
        print(self.edit_name.value)

class TodoApp():
    def __init__(self):
        self.tasks = []
        self.new_task = Textbox(placeholder='What next?', width='100%')
